...
early_stopping = keras.callbacks.EarlyStopping(min_delta=0.001, patience=1, restore_best_weights=True)
...
if __name__ == "__main__":
    ...
    model.save(os.path.join('..','models','classifier','alexnet_model.h5'), include_optimizer=False)
